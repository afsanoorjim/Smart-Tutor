"""
Django settings for smart_tutor project.
...
SECRET_KEY = "django-insecure-tvdmrg0-^t0bgswd6nwz^c!4(y-0*@^b)xzk8dw0dzakv%hz=f"
...
WSGI_APPLICATION = "smart_tutor.wsgi.application"
